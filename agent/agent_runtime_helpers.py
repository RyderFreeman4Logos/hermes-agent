...
def switch_model(agent, new_model, new_provider, api_key='', base_url='', api_mode=''):
    ...
    try:
        ...
        credential_pool = getattr(agent, "_resume_credential_pool", ...)
...
def switch_model(agent, new_model, new_provider, api_key='', base_url='', api_mode='', *, credential_pool=...):
    ...
    with model_switch_transaction_lock(agent):
        agent._resume_credential_pool = credential_pool
        try:
            result = _apply_model_switch(
                agent, new_model, new_provider, api_key, base_url, api_mode
            )
        finally:
            if hasattr(agent, "_resume_credential_pool"):
                delattr(agent, "_resume_credential_pool")
