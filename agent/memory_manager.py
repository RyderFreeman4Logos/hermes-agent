...
class MemoryManager:
    ...
    def authoritative_memory_write(
        ...
        **kwargs,
        ...
        This path never touches ``MemoryStore``. Providers must implement the
        dedicated ``authoritative_memory_write`` capability. A provider
        response is reduced to receipt/error fields so arbitrary backend
        payloads never enter the model-visible tool result.
        """
