...
DEFAULT_CONFIG = {
    ...
    "delegation": {
        ...
        # Never fall back to foreground execution (including nested
        # delegations and async-pool saturation). Rejected dispatches return
        # immediately instead.
        ...
        # Default named profile for internal callers that omit model_profile.
        "default_profile": "",
        # Named per-subagent runtime profiles. A delegate_task model_profile
        # selects one of these entries; omitted fields inherit global
        # delegation settings.
        "model_pool": {},
    },
