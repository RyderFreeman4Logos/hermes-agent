...
_KNOWN_PROVIDER_KEYS = {
    ...
    "discover_models", "extra_body", "extra_headers", "send_session_id", "capabilities", "ssl_ca_cert", "ssl_verify",
...
def _custom_provider_entry_to_provider_config(
    ...
    for field in (
        ...
        "send_session_id", "session_affinity_header", "ssl_ca_cert", "ssl_verify", "catalog_provider"):
