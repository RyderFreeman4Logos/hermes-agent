...
def _run_single_child(
    ...
    **_kwargs,
    ...
    try:
        ...
        # Seed the child's logical environment from the parent's current cwd.
        # Subsequent child `cd`s remain isolated even when the backend reuses
...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        "In a batch, each tasks[] item can override model_profile independently. "
        "Omit it to use delegation.default_profile or the global/parent routing.\n"
